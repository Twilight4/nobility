...
nb-project-end() {
	...
	# Task 3: Move the screenshot directory to projects directory
    if [ -d "~/documents/org/projects/screenshots" ]; then
        mv "~/documents/org/projects/screenshots" "${pd}"
    else
        echo "Source directory not found or is not a directory."
    fi
